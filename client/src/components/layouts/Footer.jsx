    ...
    <footer className="relative bg-gradient-to-b from-black via-gray-900 to-black text-gray-300 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-10 md:py-12">
        ...
        <div className="text-center mb-8 border-b border-gray-800 pb-8">
          ...
          <p className="text-lg md:text-xl text-purple-400 font-light mb-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          ...
          {/* About Links */}
          <div>
            <h3 className="text-white font-bold mb-3 uppercase tracking-wider text-xs border-l-2 border-purple-500 pl-2">
              Le Festival
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li><a href="/login" className="hover:text-purple-400 transition-colors flex items-center group">
                <span className="w-1 h-1 bg-gray-600 rounded-full mr-2 group-hover:bg-purple-400 transition-colors"></span>
                Se connecter
              </a></li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-6">
          <div className="flex flex-col items-center gap-3 text-xs text-gray-500">
            <p className="text-center">
              &copy; {currentYear} <span className="text-purple-400 font-semibold">MARSAI</span> - Premier festival de cinéma génératif par IA
            </p>
