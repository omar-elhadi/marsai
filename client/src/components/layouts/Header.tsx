...
function MobileLinkContent({ link, isSoumettre }) {
  return (
    <>
      <span className={`${styles.mobileLinkIndex} ${isSoumettre ? styles.mobileLinkIndexSoumettre : styles.mobileLinkIndexDefault}`}>
        {link.index}
      </span>
      ...
      <span className={`${styles.mobileLinkLabel} ${isSoumettre ? styles.mobileLinkLabelSoumettre : styles.mobileLinkLabelDefault}`}>
        {link.label}
      </span>
    </>
  );
    ...
    <>
      ...
      <header className={`${styles.header} ${isScrolled ? styles.headerScrolled : ''}`}>
        <div className={styles.headerInner}>
          ...
          >
            ...
            <span className={`${styles.burgerLine} ${styles.burgerLine1} ${isOpen ? styles.burgerLine1Open : ''}`} />
            {/* Trait 2 — disparaît à l'ouverture */}
            <span className={`${styles.burgerLine} ${styles.burgerLine2} ${isOpen ? styles.burgerLine2Open : ''}`} />
            {/* Trait 3 — rotation +45° à l'ouverture */}
            <span className={`${styles.burgerLine} ${styles.burgerLine3} ${isOpen ? styles.burgerLine3Open : ''}`} />
          </button>
      ...
      >
        ...
        <nav className={styles.mobileNav} aria-label="Navigation mobile">
          {[...NAV_LINKS, { label: 'Soumettre', href: ROUTES.SOUMETTRE, isLink: true, index: '06' }]
            .map((link, i) => {
        ...
        <div className={`${styles.panelFooter} ${isOpen ? styles.panelFooterVisible : ''}`}>
