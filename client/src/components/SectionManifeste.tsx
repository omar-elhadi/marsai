...
const CONTRAINTES = [
  {
    num:   '01',
    titre: 'Une minute',
    corps: 'Chaque œuvre est limitée à 60 secondes. La contrainte de temps est la première des libertés créatives.',
  },
  {
    num:   '02',
    titre: 'IA seule',
    corps: 'Aucun tournage réel. L\'intégralité du film — images, son, narration — est générée par intelligence artificielle.',
  },
  {
    num:   '03',
    titre: 'Cinéma authentique',
    corps: 'Malgré les outils, l\'émotion doit être vraie. L\'IA est le pinceau. L\'humanité reste le sujet.',
  },
];
  ...
  useGSAP(() => {
    ...
    ScrollTrigger.create({
      ...
      onEnter() {
        ...
        tl.to(pilaersRef.current.children, {
          opacity:  1,
          y:        0,
          duration: 0.65,
          stagger:  0.10,
  ...
  return (
    ...
    >
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        >
          {/* Ligne 1 */}
          <div className="line-mask" style={{ overflow: 'hidden', lineHeight: 1 }}>
            <span
              ref={line1Ref}
              style={{
                display:       'block',
