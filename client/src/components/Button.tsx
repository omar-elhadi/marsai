...
function Button({
  ...
  const baseStyles =
    "px-12 py-4 font-bold text-sm tracking-[0.2em] transition-all duration-300 uppercase rounded-sm shadow-lg";
  ...
  const activeStyles =
    "bg-indigo-500 text-white border border-white hover:bg-indigo-400 hover:shadow-[0_0_20px_rgba(99,102,241,0.5)] transform hover:-translate-y-1";
