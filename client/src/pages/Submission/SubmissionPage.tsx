...
const REGLES = [
  {
    index: "01",
    titre: "Ouvert à tous",
    corps: "Amateurs ou professionnels, sans distinction.",
  },
  {
    index: "02",
    titre: "60 Secondes",
    corps: "Générique inclus. Pas une de plus. La contrainte est la forme.",
  },
  {
    index: "03",
    titre: "100% IA",
    corps:
      "Génération visuelle et sonore intégralement par intelligence artificielle.",
  },
];
  ...
  useGSAP(
    () => {
      ...
      const rules = rulesRef.current
        ? Array.from(rulesRef.current.children)
        : [];
      ...
      tl.to(
        ...
        { yPercent: 0, duration: 0.85, stagger: 0.11, ease: "power3.out" },
        0.15,
      );
      tl.to(
        themeRef.current,
