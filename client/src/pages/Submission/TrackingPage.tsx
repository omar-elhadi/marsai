...
const STATUS_CONFIG = {
  ...
  TO_MODIFY: {
    ...
    description:
      "Un email contenant le lien de modification vous a été envoyé.",
    icon: AlertTriangle,
    color: "#f97316",
  ...
  APPROVED: {
    label: "Film approuvé",
    description:
      "Félicitations ! Votre film a été approuvé par l'équipe MARSAI.",
    icon: CheckCircle,
    color: "#22c55e",
  ...
  SELECTION: {
    ...
    description:
      "Votre film fait partie de la sélection officielle MARSAI 2026.",
    icon: Star,
    color: "#a855f7",
  ...
  REJECTED: {
    label: "Non retenu",
    description:
      "Votre film n'a pas été retenu cette année. Merci pour votre participation.",
    icon: XCircle,
    color: "#ef4444",
...
function Timeline({ filmStatus }: { filmStatus: string }) {
        ...
        return (
          ...
          >
            ...
            <div
              style={{
                paddingBottom:
                  index < TIMELINE_STEPS.length - 1 ? "0.25rem" : 0,
              }}
            >
              <p
                style={{
...
export default function TrackingPage() {
  ...
  useEffect(() => {
    if (!token) {
      setErrorMsg(
        "Aucun token de suivi fourni. Vérifiez le lien reçu par email.",
      );
      setStatus("error");
      return;
    }
  ...
  const config =
    STATUS_CONFIG[filmStatus as keyof typeof STATUS_CONFIG] ??
        ...
        <div style={{ flex: "2", minWidth: "300px" }}>
          ...
          <div
            style={{
              ...
              marginBottom:
                isToModify && film.modificationRequest ? "1.5rem" : 0,
              display: "flex",
              flexDirection: "column",
              gap: "1.25rem",
            }}
          >
            ...
            <InfoRow
              label="Réalisateur"
              value={[film.submitter?.firstName, film.submitter?.lastName]
                .filter(Boolean)
                .join(" ")}
            />
          ...
          >
            ...
            >
              ...
              <a
                href="mailto:festival@marsai.fr"
                style={{
                  color: "var(--color-text)",
