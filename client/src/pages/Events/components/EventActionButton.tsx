...
export default function EventActionButton({
  ...
  const barShadowIdle =
    "0 0 6px rgba(226,209,195,.82), 0 0 14px rgba(226,209,195,.36), 0 0 26px rgba(226,209,195,.13)";
  const barShadowHover =
    "0 0 12px rgba(226,209,195,1.00), 0 0 26px rgba(226,209,195,.65), 0 0 46px rgba(226,209,195,.30)";
  ...
  return (
    <button
      ...
      style={{
        animation: hovered
          ? "none"
          : "event-btn-breathe 3s ease-in-out alternate infinite",
        boxShadow: hovered
    ...
    >
      ...
      <span
        ...
        style={{
          ...
          animation: hovered
            ? "none"
            : "event-btn-bar-breathe 3s ease-in-out alternate infinite",
          boxShadow: hovered ? barShadowHover : undefined,
          transition:
            "transform 350ms var(--ease-out), box-shadow 350ms var(--ease-out)",
        }}
      />
