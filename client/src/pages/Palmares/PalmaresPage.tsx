...
function formatEdition(year: number) {
  return `Édition ${year}`;
}

function FilmCard({ nomination }: { nomination: any }) {
    ...
    >
              ...
              {editions.map((y) => (
                <button
                  ...
                  style={{
                    ...
                    background:
                      y === edition ? "var(--color-text)" : "transparent",
                    color:
                      y === edition
                        ? "var(--color-bg-pure)"
      ...
      >
        ...
        {!loading && !error && !hasContent && (
          <div
            style={{ textAlign: "center", padding: "clamp(4rem,8vw,8rem) 0" }}
          >
            <Trophy
              size={40}
              style={{
            ...
            >
              Le palmarès {edition} sera annoncé lors de la cérémonie de remise
              des prix.
              <br />
          ...
          >
            {categories
              ...
              .map((cat) => {
                ...
                const others = cat.nominations.filter((n: any) => !n.isWinner);
                // Gagnant en premier, puis les autres
                const ordered = [...(winner ? [winner] : []), ...others];
