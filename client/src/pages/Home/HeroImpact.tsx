      ...
      >
        ...
        >
          ...
          <div ref={overlineRef} className="flex items-center gap-4 mb-6">
            ...
            <span className="label-overline hidden sm:block">
              {t("hero.overline2")}
            </span>
          </div>
          ...
          {/* Date + filet */}
          <div ref={dateLineRef} className="flex items-center gap-5">
            <span className={styles.dateLineSeparator} />
            <span className={styles.dateLineText}>{t("hero.date")}</span>
          </div>
        ...
        */}
        <div className={`absolute ${styles.scrollArea}`}>
          ...
          <div
            ...
            aria-hidden="true"
          >
            <span className={styles.scrollIndicatorLabel}>
              {t("hero.scrollBtn")}
            </span>
            <svg
              width="16"
