          ...
          <div ref={rightRef}>
            {!sent ? (
              ...
              >
                ...
                >
                  <div>
                    <label htmlFor="c-prenom" style={LABEL}>
                      Prénom
                    </label>
                    <input
                      id="c-prenom"
                  ...
                  <div>
                    <label htmlFor="c-nom" style={LABEL}>
                      Nom
                    </label>
                    <input
                      id="c-nom"
                ...
                {/* Sujet */}
                <div>
                  <label htmlFor="c-sujet" style={LABEL}>
                    Sujet
                  </label>
                  <select
                    id="c-sujet"
                  ...
                  >
                    ...
                    <option value="presse" style={{ background: "#1a1a1a" }}>
                      Demande presse
                    </option>
                    <option
                      value="partenariat"
                    ...
                    <option value="autre" style={{ background: "#1a1a1a" }}>
                      Autre
                    </option>
                  </select>
                </div>
